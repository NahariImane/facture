                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form method="POST" action="AddTaxe.php" >
                             <div class="form-group">
                                <label for="taxe" class="col-form-label">la taxe *</label>
                                <input id="taxe"  name="taxe" type="text" class="form-control" required>
                            </div>
                            ...
                            <div style="text-align: center;">
                                ...
                                if ($taxe&&$typeT)
                                { 
                                   $sql = "INSERT INTO taxe(id_taxe,id_type,nom) values ('','$typeT','$taxe')";
